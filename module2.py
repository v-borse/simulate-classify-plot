...
def plot_error(Ytrue,ynrx,ynry,ynrz,Yr,YNRX,YNRY,YNRZ,YR,start,end,int_time):
    ...
    axs[0].plot(int_time[start:end],Ytrue[start:end,0]-ynrx[start:end],'^',markersize=6*2)
    axs[0].plot(int_time[start:end],Ytrue[start:end,0]-Yp[start:end,0],'*',markersize=6*2)
    axs[0].plot(int_time[start:end],Ytrue[start:end,0]-YNRX[start:end],'+',markersize=6*2)
    axs[0].plot(int_time[start:end],Ytrue[start:end,0]-YP[start:end,0],'.',markersize=10)
    axs[0].set_xlabel("integration time")
    axs[0].set_ylabel("Error" )
    axs[0].set_title("X component")
    
    axs[1].plot(int_time[start:end],Ytrue[start:end,1]-ynry[start:end],'^',markersize=6*2)
    axs[1].plot(int_time[start:end],Ytrue[start:end,1]-Yp[start:end,1],'*',markersize=6*2)
    axs[1].plot(int_time[start:end],Ytrue[start:end,1]-YNRY[start:end],'+',markersize=6*2)
    axs[1].plot(int_time[start:end],Ytrue[start:end,1]-YP[start:end,1],'.',markersize=10)
    axs[1].set_xlabel("integration time")
    axs[1].set_ylabel("Error" )
    axs[1].set_title("Y component")
    
    
    axs[2].plot(int_time[start:end],Ytrue[start:end,2]-ynrz[start:end],'^',markersize=6*2)
    axs[2].plot(int_time[start:end],Ytrue[start:end,2]-Yp[start:end,2],'*',markersize=6*2)
    axs[2].plot(int_time[start:end],Ytrue[start:end,2]-YNRZ[start:end],'+',markersize=6*2)
    axs[2].plot(int_time[start:end],Ytrue[start:end,2]-YP[start:end,2],'.',markersize=10)
...
def scatter_plots(Ytrue,ynrx,ynry,ynrz,Yr,YNRX,YNRY,YNRZ,YR,start,end):
    ...
    axs[0,0].scatter(Ytrue[start:end,0],Ytrue[start:end,0],c='k',s=10)
    #axs[0,0].plot(ynrx,'r')
    #axs[0,0].plot(Ytrue[:,0]-ynrx,'g')
    ...
    axs[1,0].scatter(Ytrue[start:end,1],Ytrue[start:end,1],c='k',s=10)
    #axs[1,0].plot(ynry,'r')
    ...
    axs[2,0].scatter(Ytrue[start:end,2],Ytrue[start:end,2],c='k',s=10)
    #axs[2,0].plot(ynrz,'r')
    ...
    axs[0,1].scatter(Ytrue[start:end,0],Ytrue[start:end,0],c='k',s=10)
    #axs[0,1].plot(YNRX,'r')
    ...
    axs[1,1].scatter(Ytrue[start:end,1],Ytrue[start:end,1],c='k',s=10)
    #axs[1,1].plot(YNRY,'r')
    ...
    axs[2,1].scatter(Ytrue[start:end,2],Ytrue[start:end,2],c='k',s=10)
    #axs[2,1].plot(YNRZ,'r')
    ...
    axs[3,0].scatter(Ytrue[start:end,0],Ytrue[start:end,0],c='k',s=10)
    #axs[3,0].plot(Yp[:,0])
    ...
    axs[4,0].scatter(Ytrue[start:end,1],Ytrue[start:end,1],c='k',s=10)
    #axs[4,0].plot(Yp[:,1])
    ...
    axs[5,0].scatter(Ytrue[start:end,2],Ytrue[start:end,2],c='k',s=10)
    #axs[5,0].plot(Yp[:,2])
    ...
    axs[3,1].scatter(Ytrue[start:end,0],Ytrue[start:end,0],c='k',s=10)
    #axs[3,1].plot(YP[:,0])
    ...
    axs[4,1].scatter(Ytrue[start:end,1],Ytrue[start:end,1],c='k',s=10)
    #axs[4,1].plot(YP[:,1])
    ...
    axs[5,1].scatter(Ytrue[start:end,2],Ytrue[start:end,2],c='k',s=10)
    #axs[5,1].plot(YP[:,2])
...
def cd_lt2(CD,lead_time):
    ...
    axs[0].plot(lead_time,CD[:,0],'^',markersize=15*2)
    axs[0].plot(lead_time,CD[:,3],'*',markersize=15*2)
    axs[0].plot(lead_time,CD[:,6],'+',markersize=15*2)
    axs[0].plot(lead_time,CD[:,9],'.',markersize=15*2)
    #axs[0,0].plot(ynrx,'r')5
    #axs[0,0].plot(Ytrue[:,0]-ynrx,'g')
    axs[0].set_xlabel("lead time")
    axs[0].set_ylabel("coef_of_det")
    axs[0].set_title("X component")
    
    axs[1].plot(lead_time,CD[:,1],'^',markersize=15*2)
    axs[1].plot(lead_time,CD[:,4],'*',markersize=15*2)
    axs[1].plot(lead_time,CD[:,7],'+',markersize=15*2)
    axs[1].plot(lead_time,CD[:,10],'.',markersize=15*2)
    #axs[1,0].plot(ynry,'r')
    axs[1].set_xlabel("lead time")
    axs[1].set_ylabel("coef_of_det")
    axs[1].set_title("Y component")
    
    axs[2].plot(lead_time,CD[:,2],'^',markersize=15*2)
    axs[2].plot(lead_time,CD[:,5],'*',markersize=15*2)
    axs[2].plot(lead_time,CD[:,8],'+',markersize=15*2)
    axs[2].plot(lead_time,CD[:,11],'.',markersize=15*2)
    #axs[2,0].plot(ynrz,'r')
...
def rmse_lt(Rmse,lead_time):
    ...
    axs[0].semilogy(lead_time,Rmse[:,0],'^',markersize=12)
    axs[0].semilogy(lead_time,Rmse[:,3],'*',markersize=12)
    axs[0].semilogy(lead_time,Rmse[:,6],'+',markersize=12)
    axs[0].semilogy(lead_time,Rmse[:,9],'.',markersize=12)
    #axs[0,0].plot(ynrx,'r')
    #axs[0,0].plot(Ytrue[:,0]-ynrx,'g')
    axs[0].set_xlabel("lead time")
    ...
    axs[1].semilogy(lead_time,Rmse[:,1],'^',markersize=12)
    axs[1].semilogy(lead_time,Rmse[:,4],'*',markersize=12)
    axs[1].semilogy(lead_time,Rmse[:,7],'+',markersize=12)
    axs[1].semilogy(lead_time,Rmse[:,10],'.',markersize=12)
    #axs[1,0].plot(ynry,'r')
    axs[1].set_xlabel("lead time")
    axs[1].set_ylabel("RMSE")
    axs[1].set_title("Y component")
    
    axs[2].semilogy(lead_time,Rmse[:,2],'^',markersize=12)
    axs[2].semilogy(lead_time,Rmse[:,5],'*',markersize=12)
    axs[2].semilogy(lead_time,Rmse[:,8],'+',markersize=12)
    axs[2].semilogy(lead_time,Rmse[:,11],'.',markersize=12)
    #axs[2,0].plot(ynrz,'r')
    axs[2].set_xlabel("lead time")
